...
Searches tasks matching the query.
...
```python
tasks = manager.search_tasks("documentation")
```
...
- **file_path (str)** — location to export tasks

Example:

```python
storage.export_tasks_json("backup_tasks.json")
```
